...
namespace Foam
{
    defineTypeNameAndDebug(incompressibleTwoPhaseMixturePartial, 0);
}


// * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * * //

/*void Foam::incompressibleTwoPhaseMixturePartial::calcNu()
{
    nuModel1_->correct();
    nuModel2_->correct();
...
Foam::incompressibleTwoPhaseMixturePartial::incompressibleTwoPhaseMixturePartial
(
...
Foam::incompressibleTwoPhaseMixturePartial::mu() const
{
    const volScalarField limitedAlpha1
    (
        clamp(alpha1_, zero_one{})
...
Foam::incompressibleTwoPhaseMixturePartial::mu(const label patchI) const
{
...
Foam::incompressibleTwoPhaseMixturePartial::muf() const
{
...
Foam::tmp<Foam::surfaceScalarField>
Foam::incompressibleTwoPhaseMixturePartial::nuf() const
{
    const surfaceScalarField alpha1f
    (
        clamp(fvc::interpolate(alpha1_), zero_one{})
...
bool Foam::incompressibleTwoPhaseMixturePartial::read()
{
/*
    if (regIOobject::read())
    {
