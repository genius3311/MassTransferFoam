...
inline int mkdirs(const std::string& dir) {std::error_code ec; std::experimental::filesystem::create_directories(dir, ec);	 return ec.value(); /*filesystem::permissions(dir, filesystem::perms::owner_all, filesystem::perm_options::add);*/}
...
// used by SiRun and VxlPro commands
